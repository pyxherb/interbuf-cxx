...
#if defined(_MSC_VER)
	#define INTERBUF_DECL_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...) extern template class api_modifier name<__VA_ARGS__>
	#define INTERBUF_DEF_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...) template class api_modifier name<__VA_ARGS__>
#elif defined(__GNUC__) || defined(__clang__)
	#define INTERBUF_DECL_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...) extern template class api_modifier name<__VA_ARGS__>
	#define INTERBUF_DEF_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...) template class name<__VA_ARGS__>
#else
	#define INTERBUF_DECL_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...)
	#define INTERBUF_DEF_EXPLICIT_INSTANTIATED_CLASS(api_modifier, name, ...)
#endif
